...
const appCss = "/assets/styles-BWjb_aS8.css";
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Something went wrong on my end. You can try refreshing or head back home." }),
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:site", content: "@shelkeaditya" }
    ],
    links: [
      {
        rel: "stylesheet",
...
const $$splitComponentImporter = () => import("./index-L_8Chqe_.js");
