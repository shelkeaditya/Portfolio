...
const appCss = "/assets/styles-BBLnJmHo.css";
...
function ErrorComponent({ error, reset }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md text-center", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "Something went wrong on my end. You can try refreshing or head back home." }),
...
const $$splitComponentImporter = () => import("./index-DFq9cam0.js");
